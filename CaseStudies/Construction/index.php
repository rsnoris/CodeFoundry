<?php
$page_title  = 'CodeFoundry Case Study: Architecture & Construction';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Architecture &amp; Construction Use Cases</h2>
  <p class="section-desc">
    CodeFoundry drives modern projects for architecture, engineering and construction with BIM, IoT, supply chain, compliance, and operational analytics.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Building Information Modeling (BIM) Integration</div>
    <div class="scenario-text">Design/construction firms collaborate digitally on plans, models, change orders and 4D/5D scheduling.</div>
    <ul class="scenario-features-list">
      <li>Cloud-based BIM for role-based access, clash detection, and document versioning.</li>
      <li>Mobile apps for field change and real-time progress tracking.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Site IoT Safety & Asset Monitoring</div>
    <div class="scenario-text">Automated logging for equipment location, usage, health, and personnel safety via sensors and wearables.</div>
    <ul class="scenario-features-list">
      <li>Live alerts for unauthorized entry, hazardous conditions, and predictive maintenance.</li>
      <li>Compliance reporting and risk dashboards for safety officers and PMs.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Mobile Field Productivity Apps</div>
    <div class="scenario-text">General contractors and subs deploy mobile apps for punch lists, work order allocation, time-keeping and photo/doc uploads.</div>
    <ul class="scenario-features-list">
      <li>Offline access, secure data sync, and job progress analytics.</li>
      <li>Improved reporting accuracy, workflow transparency, and payout cycle.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Supply Chain & Materials Management Platform</div>
    <div class="scenario-text">Suppliers, logistics, and crews are unified in real-time dashboards for order tracking, delivery, and site inventory.</div>
    <ul class="scenario-features-list">
      <li>Mobile barcode scanning, real-time ETA and stockout monitoring.</li>
      <li>Automated reordering and bidding for materials/supplies.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Digital Permit & Compliance Workflow</div>
    <div class="scenario-text">Owners and contractors manage permit, inspection, and code compliance with secure app-driven workflow and digital signatures.</div>
    <ul class="scenario-features-list">
      <li>Automated reminders, mobile photo/document uploads, real-time developer and inspector messaging.</li>
      <li>Faster approval cycle, improved audit and stakeholder visibility.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Client & Stakeholder Engagement Platform</div>
    <div class="scenario-text">Clients and project teams track progress, budgets, change orders, milestones, and visualize BIM/3D via secure portal.</div>
    <ul class="scenario-features-list">
      <li>Role-based dashboard, messaging and mobile push notifications.</li>
      <li>Enhanced project trust and satisfaction.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">7. ESG & Sustainability Monitoring</div>
    <div class="scenario-text">Real-time analytics and reporting for energy use, waste, carbon, and materials sourcing at project and operation level.</div>
    <ul class="scenario-features-list">
      <li>Automated reporting for LEED, local and international standards.</li>
      <li>Stakeholder portal, risk alerts, and transparent audits.</li>
    </ul>
  </div>
</main>
