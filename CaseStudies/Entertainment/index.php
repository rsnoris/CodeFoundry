<?php
$page_title  = 'CodeFoundry Case Study: Art & Entertainment';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Art &amp; Entertainment Use Cases</h2>
  <p class="section-desc">
    CodeFoundry supports artists, galleries, live venues, streaming platforms, and creative brands with immersive digital experiences, audience analytics, and mobile engagement.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Digital Gallery & Curated Platform</div>
    <div class="scenario-text">Visual arts company launches an online gallery with HD viewing, mobile-first exhibitions, artist dashboards, and sales integration.</div>
    <ul class="scenario-features-list">
      <li>VR/AR tour feature, integrated video and artist talk overlays.</li>
      <li>Curator, artist, and buyer role management, secure payment APIs.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Event Ticketing & Mobile Engagement</div>
    <div class="scenario-text">Theater and music venues automate digital tickets, mobile loyalty, and guest feedback for shows, tours, and festivals.</div>
    <ul class="scenario-features-list">
      <li>QR code, loyalty, group booking, referral bonuses, and push notifications.</li>
      <li>Live polling and mobile guest feedback analytics.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Streaming, Creator & Artist Fan Platform</div>
    <div class="scenario-text">A content company launches mobile engagement, live-stream, and creator monetization for artists, musicians and entertainers.</div>
    <ul class="scenario-features-list">
      <li>Creator profiles & dashboards, in-app micro-payments and subscriptions.</li>
      <li>Multi-platform streaming, chat, fan contests, and leaderboard campaigns.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. NFT & Digital Collectibles Marketplace</div>
    <div class="scenario-text">Entertainment/creative startup launches a digital collectibles and NFT trading platform with blockchain for art, sports, and music.</div>
    <ul class="scenario-features-list">
      <li>Secure contract, loyalty tiers, wallet API and mobile minting.</li>
      <li>Community-driven curation and drop tools.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Audience & Event Analytics Suite</div>
    <div class="scenario-text">Venues and brands use AI for ticket predictions, personalized content, engagement feedback and campaign ROI in real time.</div>
    <ul class="scenario-features-list">
      <li>Multi-channel dashboard, segmentation, churn alerts, and smart recommendations.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Social Sharing, Collaboration & Rights Management</div>
    <div class="scenario-text">Creative companies use digital platforms for project collaboration, secure rights management, review workflows, and attribution tracking.</div>
    <ul class="scenario-features-list">
      <li>Role-based sharing, peer reviews, copyright registration, transparent revenue splits.</li>
    </ul>
  </div>
</main>
