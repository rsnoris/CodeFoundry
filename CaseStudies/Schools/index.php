<?php
$page_title  = 'CodeFoundry Case Study: Education & Schools';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Education &amp; Schools Use Cases</h2>
  <p class="section-desc">
    CodeFoundry helps educational institutions and edtechs deploy smart platforms, adaptive learning, campus management, and digital communications.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Digital Classroom Management Portal</div>
    <div class="scenario-text">K12 and higher-ed institutions use portals for assignments, grading, attendance, and parent communications on web and mobile.</div>
    <ul class="scenario-features-list">
      <li>Role-based dashboards for teachers, students, and parents; multi-lingual support and secure file/document sharing.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Adaptive Learning & Assessment Suite</div>
    <div class="scenario-text">Schools deliver adaptive quizzes, learning paths, and skill analytics for every student, teacher, and admin.</div>
    <ul class="scenario-features-list">
      <li>AI-based personalized content creation, question banks, and reporting dashboards.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Campus Operations & Scheduling Platform</div>
    <div class="scenario-text">Institutions automate facility use, lesson timetables, event calendars, transport schedules and room bookings.</div>
    <ul class="scenario-features-list">
      <li>Mobile booking, resource tracking, and real-time communication flows.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Student Success and Analytics Dashboards</div>
    <div class="scenario-text">Administrators and teachers track attendance, progress, intervention, and personalized recommendations for students.</div>
    <ul class="scenario-features-list">
      <li>Predictive alerts for at-risk students, parent outreach and program reporting tools.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Virtual & Blended Learning Platform</div>
    <div class="scenario-text">Schools enable multi-device digital classrooms, live/video learning, homework, tests and project collaboration.</div>
    <ul class="scenario-features-list">
      <li>Integration with Microsoft Teams, Zoom, Google Meet and mobile chat features.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Secure Records & Compliance Automation</div>
    <div class="scenario-text">Registrar and admin staff use digital records and compliance automation for attendance, transcripts, reporting, and privacy (FERPA/GDPR).</div>
    <ul class="scenario-features-list">
      <li>Role-based record access, self-service transcripts, audit logs, and reporting APIs.</li>
    </ul>
  </div>
</main>
