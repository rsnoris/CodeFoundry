<?php
$page_title  = 'CodeFoundry Case Study: Nonprofit & Social Impact';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Nonprofit & Social Impact Use Cases</h2>
  <p class="section-desc">
    CodeFoundry accelerates social good for nonprofits and NGOs with digital transformation, donor engagement, data transparency, and optimized service delivery.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Digital Donation & Crowdfunding Platform</div>
    <div class="scenario-text">A global NGO needed an easy-to-use donation portal, with campaigns, recurring giving, and peer-to-peer fundraising.</div>
    <ul class="scenario-features-list">
      <li>Mobile, web, and social integration (Apple/Google Pay, JustGiving, Facebook, etc).</li>
      <li>Automated receipts, gift-matching workflows, and real-time campaign dashboards.</li>
      <li>Increased donations, supporter retention, and global reach.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Impact Analytics & Outcomes Dashboard</div>
    <div class="scenario-text">A foundation wanted to rigorously track program results and impact with custom dashboards and data visualization.</div>
    <ul class="scenario-features-list">
      <li>Data ingestion from partners, surveys, field staff apps, sensed data (IoT where relevant).</li>
      <li>Automated visualization and real-time alerts for KPIs/goals by region and program.</li>
      <li>Published progress and compliance reports for donors, boards, and government.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Field Operative Mobile Platform</div>
    <div class="scenario-text">A humanitarian nonprofit launched an offline/low-bandwidth mobile solution for medical and logistics teams.</div>
    <ul class="scenario-features-list">
      <li>Case reporting, GIS-map, inventory/order apps with offline sync and auto-upload.</li>
      <li>Security and data privacy for at-risk locations and teams.</li>
      <li>Real-time coordination with headquarters and donors for urgent needs.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Volunteer Matching & Scheduling</div>
    <div class="scenario-text">A citywide nonprofit coalition digitalized volunteer intake, onboarding, training, and event scheduling.</div>
    <ul class="scenario-features-list">
      <li>Mobile/desktop app for sign-up, credentials, shifts, training, and reminders.</li>
      <li>Automated match-making for location, skill, and interest; feedback and reward system built in.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Grant Management & Automated Reporting</div>
    <div class="scenario-text">A grant-making organization moved to a fully digital workflow for proposal submission, review, awards, and reporting.</div>
    <ul class="scenario-features-list">
      <li>Role-based submission portal, guided applications, status tracking.</li>
      <li>Milestone analytics, reporting and documentation flows, payment triggers on approval.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Online Education/Resource Library</div>
    <div class="scenario-text">A literacy nonprofit created a digital hub for curriculum, e-learning, and resource sharing with parents and teachers worldwide.</div>
    <ul class="scenario-features-list">
      <li>Multilingual content, video, quizzes; user management and progress tracking.</li>
      <li>Offline access, print/PDF downloads, and API for third-party integration.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">7. Transparency, Anti-Fraud & Compliance Automation</div>
    <div class="scenario-text">A large international relief organization integrated digital audits, payment traceability, and anti-bribery controls.</div>
    <ul class="scenario-features-list">
      <li>Blockchain receipt logging for donations, supplies, and vendor payments.</li>
      <li>Automated compliance and local law reporting.</li>
    </ul>
  </div>
</main>
