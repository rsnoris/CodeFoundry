<?php
$page_title  = 'CodeFoundry Case Study: Hospitality & Hotels';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Hospitality &amp; Hotels Use Cases</h2>
  <p class="section-desc">
    CodeFoundry helps hotels and hospitality providers deliver exceptional guest experiences, operational efficiency, and innovative digital platforms.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Digital Guest Experience Suite</div>
    <div class="scenario-text">Hotels launch mobile check-in/out, digital keys, room service, loyalty, and real-time feedback for every guest.</div>
    <ul class="scenario-features-list">
      <li>Mobile-first dashboard, text/chat service integration, push notifications, and review flows.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Smart Facility Management & IoT</div>
    <div class="scenario-text">Operators automate HVAC, lighting, access, and amenities for energy savings and predictive maintenance.</div>
    <ul class="scenario-features-list">
      <li>Centralized dashboard, guest controls, and service engineer mobile system.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Dynamic Pricing & Revenue Management</div>
    <div class="scenario-text">Hotel group deploys AI-based pricing engine for room, service, and package optimization by season, segment, and event.</div>
    <ul class="scenario-features-list">
      <li>Integrated market, event, and booking analytics; competitor price intelligence.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Integrated Reservation & PMS Platform</div>
    <div class="scenario-text">Hotels and chains unify bookings, inventory, housekeeping, and billing with mobile-friendly PMS.</div>
    <ul class="scenario-features-list">
      <li>API integration with OTAs, GDS, and guest messaging platform.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Group/Event Management and Analytics</div>
    <div class="scenario-text">Convention/meeting hotels manage RFPs, contracts, scheduling, service and guest tracking via live dashboards and mobile apps.</div>
    <ul class="scenario-features-list">
      <li>Automated proposals, self-service event setup, group communication flows.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Sustainability & ESG Reporting Dashboard</div>
    <div class="scenario-text">Hospitality chains monitor energy, waste, water, and carbon KPIs, automate guest transparency and stakeholder reports.</div>
    <ul class="scenario-features-list">
      <li>Mobile/online reporting, audit-ready scoring, and consumer-facing sustainability badge program.</li>
    </ul>
  </div>
</main>
