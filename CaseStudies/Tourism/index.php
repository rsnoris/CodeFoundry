<?php
$page_title  = 'CodeFoundry Case Study: Travel & Tourism';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Travel &amp; Tourism Use Cases</h2>
  <p class="section-desc">
    CodeFoundry empowers travel agencies, operators, and tourism portals with digital booking, guest experience, smart itineraries, and mobile engagement.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. Mobile Booking & Trip Planner App</div>
    <div class="scenario-text">Travel agency launches all-in-one booking with AI-powered itinerary recommendations, e-tickets, and rich media guides.</div>
    <ul class="scenario-features-list">
      <li>Integrated payment, real-time travel alerts, and social sharing modules.</li>
      <li>Personalized recommendations, loyalty, and upsell engine.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Smart City Tour Management Platform</div>
    <div class="scenario-text">Operator manages group tours, bookings, guides, check-ins, and resource logistics via cloud dashboard and mobile guide app.</div>
    <ul class="scenario-features-list">
      <li>GPS-enabled real-time location, digital check-in, live feedback and schedule updates.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Omnichannel Guest Service Chatbot</div>
    <div class="scenario-text">Destination launches multi-language mobile chatbots for FAQs, restaurant/hotel tips, event info, and emergency help.</div>
    <ul class="scenario-features-list">
      <li>Conversational AI for personalized content; handoff to human agents where needed.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Automated Partner/Travel Package APIs</div>
    <div class="scenario-text">Aggregator combines flights, hotels, rentals, excursions with real-time pricing and inventory.</div>
    <ul class="scenario-features-list">
      <li>RESTful APIs for suppliers; mobile and web integrations for instant quotes and booking.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Smart Loyalty & Referral Reward Engine</div>
    <div class="scenario-text">Travel platform automates loyalty tiers, referral bonuses, gamified campaigns, and group booking discounts.</div>
    <ul class="scenario-features-list">
      <li>Mobile push notifications, campaign analytics, self-service reward redemption.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Sustainability, ESG, and Destination Analytics</div>
    <div class="scenario-text">Tourism board provides transparency and ESG scoring for destinations, operators, and traveler impact.</div>
    <ul class="scenario-features-list">
      <li>Live dashboard, API integration, QR codes for traveler sustainability actions.</li>
    </ul>
  </div>
</main>
