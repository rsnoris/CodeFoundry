<?php
$page_title  = 'CodeFoundry Case Study: Agriculture & Farming';
...
<section class="section-heading">
  ...
  <h2 class="section-title">Agriculture &amp; Farming Use Cases</h2>
  <p class="section-desc">
    CodeFoundry helps farms and agribusinesses thrive by implementing smart automation, data analytics, and digital supply chain platforms.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">1. IoT-Powered Precision Agriculture</div>
    <div class="scenario-text">Farms deploy sensors across fields, greenhouse, and livestock for real-time data and automated alerts for irrigation, feed, and disease control.</div>
    <ul class="scenario-features-list">
      <li>Mobile dashboard for live conditions, weather, soil, and yield analytics.</li>
      <li>Automated pump/feeder triggers and predictive health monitoring.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">2. Crop Management & Automated Planning Suite</div>
    <div class="scenario-text">Growers use workflow and calendar apps to schedule planting, fertilizing, scouting, and harvesting backed by AI recommendations.</div>
    <ul class="scenario-features-list">
      <li>Integrated task automation, satellite/drone data for crop stress and field zones.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">3. Supply Chain Tracking from Field to Fork</div>
    <div class="scenario-text">Producer enables ingredient, lot, and batch traceability for downstream processing and retailer reporting.</div>
    <ul class="scenario-features-list">
      <li>QR code and mobile scan at every stage, compliance automation, rapid recalls.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">4. Farm Equipment Fleet & Predictive Maintenance</div>
    <div class="scenario-text">Aggregator uses OTA connectivity for field machinery, predictive service scheduling, and downtime analytics.</div>
    <ul class="scenario-features-list">
      <li>Fuel, location, job queue and alert integration; smart service triggers.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">5. Digital Marketplace for Seed, Fertilizer, Crop Trade</div>
    <div class="scenario-text">A trading platform connects producers, buyers, and ag retailers with dynamic pricing, digital contracts, and payment APIs.</div>
    <ul class="scenario-features-list">
      <li>Mobile auction and marketplace, smart bidding, reporting, and compliance engine.</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">6. Regulatory & Sustainability Analytics</div>
    <div class="scenario-text">Farm and co-op management deploy ESG/organic compliance dashboards, water/carbon analytics, and stakeholder reporting.</div>
    <ul class="scenario-features-list">
      <li>Automated compliance alerts, reports, and branded consumer transparency portal.</li>
    </ul>
  </div>
</main>
