<?php
$page_title  = 'Documentation - CodeFoundry';
$active_page = '';
$page_styles = <<<'PAGECSS'
:root {
      --navy: #0e1828;
...
<main>
  <div class="page-header">
    <span class="page-badge">Technical Resources</span>
    <h1 class="page-title">Documentation Hub</h1>
    <p class="page-desc">
      Access comprehensive guides, API references, and technical documentation for all CodeFoundry services and solutions.
    </p>
  </div>
  ...
  <div class="doc-grid">
    ...
    <div class="doc-card">
      ...
      <h3 class="doc-title">Cloud Solutions</h3>
      <p class="doc-desc">
    ...
    <div class="doc-card">
      ...
      <h3 class="doc-title">Security & Compliance</h3>
      <p class="doc-desc">
    ...
    <div class="doc-card">
      ...
      <h3 class="doc-title">Training Resources</h3>
      <p class="doc-desc">
