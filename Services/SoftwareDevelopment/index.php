<?php
$page_title  = 'CodeFoundry Service: Software Development';
...
<section class="section-heading">
  ...
  <p class="section-desc">
    CodeFoundry delivers world-class custom software development—from web and mobile apps to enterprise platforms, APIs, and cloud-native systems.
  </p>
</section>
<main class="scenarios-main">
  <div class="scenario-card">
    <div class="scenario-title">Custom Web Applications</div>
    <div class="scenario-text">Build scalable, responsive web applications tailored to your business needs with modern frameworks and technologies.</div>
    <ul class="scenario-features-list">
      <li>React, Angular, Vue.js frontend development</li>
      <li>Node.js, Python, .NET backend systems</li>
      <li>Progressive Web Apps (PWA) for offline capability</li>
      <li>Real-time features with WebSockets and event streaming</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">Mobile App Development</div>
    <div class="scenario-text">Native and cross-platform mobile applications for iOS and Android that deliver exceptional user experiences.</div>
    <ul class="scenario-features-list">
      <li>Native iOS (Swift) and Android (Kotlin) development</li>
      <li>Cross-platform with React Native and Flutter</li>
      <li>Mobile-first design and optimization</li>
      <li>App Store and Google Play deployment</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">API Development & Integration</div>
    <div class="scenario-text">Design and build robust APIs that power integrations, microservices, and third-party connectivity.</div>
    <ul class="scenario-features-list">
      <li>RESTful and GraphQL API design</li>
      <li>API gateway and management solutions</li>
      <li>Third-party integration (payment, CRM, ERP)</li>
      <li>API documentation and developer portals</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">Enterprise Software Solutions</div>
    <div class="scenario-text">Large-scale enterprise applications with complex workflows, security, and compliance requirements.</div>
    <ul class="scenario-features-list">
      <li>ERP and CRM system development</li>
      <li>Legacy system modernization</li>
      <li>Multi-tenant SaaS platforms</li>
      <li>Enterprise integration and data migration</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">Cloud-Native Development</div>
    <div class="scenario-text">Build applications optimized for cloud environments with scalability, resilience, and cost-efficiency.</div>
    <ul class="scenario-features-list">
  ...
  <div class="scenario-card">
    <div class="scenario-title">E-commerce Platforms</div>
    <div class="scenario-text">Full-featured e-commerce solutions with payment processing, inventory management, and customer experiences.</div>
    <ul class="scenario-features-list">
      <li>Custom shopping cart and checkout flows</li>
      <li>Payment gateway integration</li>
      <li>Product catalog and inventory systems</li>
      <li>Order management and fulfillment</li>
    </ul>
  </div>
  <div class="scenario-card">
    <div class="scenario-title">DevOps & CI/CD</div>
    <div class="scenario-text">Streamline development workflows with automated testing, deployment pipelines, and infrastructure as code.</div>
    <ul class="scenario-features-list">
  ...
  <div class="scenario-card">
    <div class="scenario-title">Quality Assurance & Testing</div>
    <div class="scenario-text">Comprehensive testing strategies to ensure software quality, performance, and security.</div>
    <ul class="scenario-features-list">
