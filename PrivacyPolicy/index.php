<?php
$page_title  = 'Privacy Policy - CodeFoundry';
$active_page = '';
$page_styles = <<<'PAGECSS'
:root {
      --navy: #0e1828;
...
<main>
  <div class="page-header">
    ...
    <p class="page-subtitle">Last Updated: January 1, 2024</p>
  </div>

  <div class="content">
    <h2>Introduction</h2>
    <p>
      At CodeFoundry ("we," "our," or "us"), we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
    </p>
    <p>
    ...
    <p>
      To exercise these rights, please contact us at <a href="mailto:privacy@codefoundry.cloud">privacy@codefoundry.cloud</a>.
    </p>
    ...
    <p>
      <strong>Email:</strong> <a href="mailto:privacy@codefoundry.cloud">privacy@codefoundry.cloud</a><br>
      <strong>Phone:</strong> +1 234 567 890<br>
      <strong>Address:</strong> 156 Foundry Ave., Suite 502, New York, NY, USA
    </p>
  </div>
</main>
